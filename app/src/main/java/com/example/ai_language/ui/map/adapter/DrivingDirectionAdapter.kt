...
import com.example.ai_language.databinding.ItemDrivingDetailBinding
...
class DrivingDirectionAdapter : RecyclerView.Adapter<DrivingDirectionAdapter.WalkDirectionViewHolder>() {
    ...
    class WalkDirectionViewHolder(
        private val binding: ItemDrivingDetailBinding
        ...
        companion object {
            fun from(parent: ViewGroup): WalkDirectionViewHolder {
                return WalkDirectionViewHolder(
                    ItemDrivingDetailBinding.inflate(
