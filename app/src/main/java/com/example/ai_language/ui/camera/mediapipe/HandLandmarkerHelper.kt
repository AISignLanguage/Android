...
//    }
//
//    // 현재 사용 중인 Hand Landmarker를 닫고, 관련된 리소스를 해제하는 함수
//    fun clearHandLandmarker() {
//        handLandmarker?.close()
//        handLandmarker = null
//    }
//
//    // Hand Landmarker가 닫혔는지 여부를 반환하는 함수
//    fun isClose(): Boolean {
//        return handLandmarker == null
//    }
//
//    // Initialize the Hand landmarker using current settings on the (Hand Landmarker를 초기화하고 설정)
//    // thread that is using it. CPU can be used with Landmarker (CPU 또는 GPU를 사용하여 모델을 실행하도록 설정)
//    // that are created on the main thread and used on a background thread, but
//    // the GPU delegate needs to be used on the thread that initialized the
//    // Landmarker (설정된 옵션에 따라 Hand Landmarker를 생성)
...
//        Log.d("HandLandmarkerHelper", "$MP_HAND_LANDMARKER_TASK")
//
...
//    }
//
//    // 카메라 프레임에서 손 랜드마크를 감지하는 함수 (LandmarkerListener로 결과 반환)
...
//    }
//
//    // 비동기적으로 손 랜드마크를 감지 (RunningMode.LIVE_STREAM 모드에서만 사용됨)
...
//    }
//
//    // 비디오 파일에서 각 프레임에서 손 랜드마크를 감지하는 함수 (ResultBundle 객체로 결과 반환)
...
//    }
//
//    // 이미지에서 손 랜드마크를 감지하는 함수 (결과를 ResultBundle 객체로 반환)
...
//    }
//
//    // RunningMode.LIVE_STREAM 모드에서 손 랜드마크 감지 작업이 완료되면 호출 (LandmarkerListener로 결과 반환)
...
//    }
//
//    // RunningMode.LIVE_STREAM 모드에서 손 랜드마크 감지 중 오류가 발생하면 호출됨
